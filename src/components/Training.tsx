...
const getSchedule = (id: string, schedules: TrainingSchedule[]) => {
  return schedules.find((schedule) => schedule.id === id);
};

const getActiveSchedule = (schedules: TrainingSchedule[]) => {
...
const Training = (props: { schedules: TrainingSchedule[], customer_id: string }) => {
  ...
  return (
    <div className={classes.container}>
      ...
      {
         <TrainingForm schedule={schedule} customer_id={props.customer_id}/>
      }
    </div>
  );
}
